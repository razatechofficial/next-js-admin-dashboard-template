...
const ModernHero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-16 left-4 sm:left-10 w-12 h-12 sm:w-16 sm:h-16 bg-green-500/10 border border-green-500/20 rounded-xl backdrop-blur-sm"></div>
        <div className="absolute top-32 right-4 sm:right-20 w-8 h-8 sm:w-12 sm:h-12 bg-blue-500/10 border border-blue-500/20 rounded-lg backdrop-blur-sm"></div>
        <div className="absolute bottom-32 left-4 sm:left-20 w-10 h-10 sm:w-14 sm:h-14 bg-purple-500/10 border border-purple-500/20 rounded-xl backdrop-blur-sm"></div>
        <div className="absolute bottom-16 right-4 sm:right-10 w-6 h-6 sm:w-10 sm:h-10 bg-cyan-500/10 border border-cyan-500/20 rounded-lg backdrop-blur-sm"></div>
      </div>
