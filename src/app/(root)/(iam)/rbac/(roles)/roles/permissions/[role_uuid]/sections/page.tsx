...
import AddAppServiceSectionPermission from "./_Forms/AddAppServiceSectionPermission";
...
const AppServiceSectionsPermissions = () => {
  ...
  return (
    <div>
      ...
      <Modal
        ...
        size="md"
      >
        <AddAppServiceSectionPermission
...
export default AppServiceSectionsPermissions;
